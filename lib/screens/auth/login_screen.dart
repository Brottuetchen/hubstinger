                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: AppColors.violet.withOpacity(0.5), blurRadius: 40),
                        ],
                      ),
                      child: const Center(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Row(children: [
                            Icon(Icons.dns_outlined, size: 14, color: Colors.white38),
                            const SizedBox(width: 6),
                            Text(_urlCtrl.text.isNotEmpty ? _urlCtrl.text : 'Server-URL',
                              style: const TextStyle(fontSize: 12, color: Colors.white38)),
                            const Spacer(),
                            Icon(_showServerField ? Icons.expand_less : Icons.expand_more,
