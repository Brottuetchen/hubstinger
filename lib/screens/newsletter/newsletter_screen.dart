  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: ListView(
          ...
          const Text('Wöchentlich · automatisch via n8n',
              ...
              return GlassCard(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text('${newsletters.length} Ausgaben im Archiv',
                          style: const TextStyle(
                              fontSize: 13, color: AppColors.white40)),
                    ]),
              );
            },
          ),
              ...
              if (newsletters.isEmpty) {
                return const GlassCard(
                  ...
                  child: Column(children: [
                    ...
                    SizedBox(height: 12),
                    Text('Noch keine Newsletter',
                        style: TextStyle(
                            fontSize: 15, fontWeight: FontWeight.w600)),
                    SizedBox(height: 6),
                    Text('Der erste wird freitags via n8n generiert.',
                ...
                children: newsletters.asMap().entries.map((entry) {
                  ...
                  return Padding(
                    ...
                    child: GlassCard(
                      borderRadius: 22,
                      weight: GlassWeight.mid,
                      rimColor: color.withOpacity(0.3),
          ...
          child: Row(children: [
            GlassCard(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(AppIcons.back, size: 14, color: Colors.white60),
                    SizedBox(width: 6),
                    Text('Zurück',
                ...
                child: Column(
                  ...
                  Text(title,
                      style: const TextStyle(
                          ...
                          fontWeight: FontWeight.w800,
                          letterSpacing: -0.5)),
                  Text('KW $week · $count Empfehlungen',
                      style:
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Padding(
                      ...
                      child: GlassCard(
                              ...
                              tint: AppColors.violet.withOpacity(0.08),
...
extension _DateTimeIso on DateTime {
  List<int> isocalendar() {
    ...
    if (daysDiff < 0) {
      ...
      final startOfPrevWeek1 =
          prevYear.subtract(Duration(days: prevYear.weekday - 1));
